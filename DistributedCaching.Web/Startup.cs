...
namespace DistributedCaching.Web
{
    public class Startup
    {
        ...
        private IWebHostEnvironment HostContext { get; }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            else
            {
                ...
                #region SqlServer Caching

                
                services.AddDistributedSqlServerCache(options =>
                {
                    options.ConnectionString = Configuration["DistributedCacheConnectionString"];
